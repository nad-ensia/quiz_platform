      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <button 
            ...
            className="w-full p-2 flex items-center justify-center border border-[#3F8CAA] rounded-md text-[#30393D] bg-[#3F8CAA]/10 mb-3 text-sm"
          >
        ...
        <div className="flex justify-center">
          <button 
            onClick={handleNext}
            className="bg-transparent text-[#3F8CAA] border border-[#3F8CAA] rounded px-8 py-2 text-base font-semibold cursor-pointer mt-4"
          >
            Next
          </button>
        </div>
